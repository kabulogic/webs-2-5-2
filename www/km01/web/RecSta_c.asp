...
<body onload="initVideoTable('通道');setOperator();startGet();" onunload="stopGet();">
<iframe src="status.asp" name="status" style="display:none"></iframe> 
<form name="RecSta">
<input type="hidden" name="operator" value="" /><input type="hidden" name="lang" value="cn" />
 <table width="840" cellpadding="0" cellspacing="0" class="table">
  <tr>
    <th width="164" height="30"></th>
    <th width="210">视频状态 </th>
    <th width="232">录像状态 </th>
    <th width="232">报警状态 </th>
  </tr></table>
 ...
 <table width="840" cellpadding="0" cellspacing="0"  class="bottom">
  <tr style="display:none">
    <th width="164" height="30"></th>
    <th width="210"><input type="button" name="PageUp" value="上一页" onclick="onPageUp()" /></th>
    <th width="232"><input type="button" name="PageDown" value="下一页" onclick="onPageDown()" /></th>
    <th width="232"></th>
  </tr>
  </table>
