...
static const char Move_Table[16]={
...
extern void BitsCopy(bool *DatOut,bool *DatIn,int Len);  // 数组复制 

extern void bytetobit(bool *DatOut,char *DatIn,int Num);       // OK
extern void ByteToBit(bool *DatOut,char *DatIn,int Num); // 字节到位 
extern void BitToByte(char *DatOut,bool *DatIn,int Num); // 位到字节

extern void BitToHex(char *DatOut,bool *DatIn,int Num);  // 二进制到十六进制 64位 to 4*16字符
extern void HexToBit(bool *DatOut,char *DatIn,int Num);  // 十六进制到二进制 

extern void TablePermute(bool *DatOut,bool *DatIn,const char *Table,int Num); // 位表置换函数 
extern void LoopMove(bool *DatIn,int Len,int Num);     // 循环左移 Len长度 Num移动位数 
...
extern void SetKey(char KeyIn[8]);                         // 设置密钥
