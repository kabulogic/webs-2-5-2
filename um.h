...
//zed
/* Privilege Port Access */
#define PRIV_PORT		0x00
#define PRIV_MANAGER	0x01
#define PRIV_DIVICE		0x02
#define PRIV_SECURITY	0x03
#define PRIV_SYSTEM		0x04
/*
 *	User classes
 */
 ...
 */
extern int				umAddGroup(char_t *group, bool_t bportA,
							bool_t buserM, bool_t bdiviceS, bool_t securityM, bool_t systemM);
...
extern int umSearchStr(char_t* tablename, char_t* columnname, char_t* userGroupName);
extern int umReadStr(char_t* tablename, char_t* um, int row, char_t** returnValue);
extern int umWriteStr(char_t *tablename, char_t *um, int row, char_t *str);
extern int umWriteInt(char_t* tablename, char_t* um, int row, int iData);
extern int umDeleteRow(char_t* tablename, int row);
extern int umReadInt(char_t* tablename, char_t* um, int row);
extern int umSetUserName(char_t *user, char_t *newuser);
